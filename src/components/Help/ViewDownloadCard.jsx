...
const RELATIVE_PATH = 'vue-fm26-progress-tracker.fmf';
...
const VIEW_URL = `${import.meta.env.BASE_URL}${RELATIVE_PATH}`;
    ...
    <div className="view-download-card">
      ...
      <div className="view-download-text">
        ...
        <p>
          ...
          reconnues par l'application (identité, technique, mental, physique, gardien…).
        </p>
