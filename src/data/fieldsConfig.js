...
export const IDENTITY_FIELDS = [
  ...
  { key: 'uid', label: 'ID unique', aliases: ['Unique ID', 'UID', 'ID unique', 'Id unique', 'Identifiant unique'] },
  ...
  { key: 'position', label: 'Position', aliases: ['Position', 'Positions'] },
  { key: 'club', label: 'Club', aliases: ['Club', 'Équipe', 'Equipe', 'Team', 'Club actuel'] },
  { key: 'division', label: 'Division', aliases: ['Division', 'Division actuelle', 'Championnat', 'League', 'Compétition'] },
  ...
  { key: 'joueur_du_match', label: 'Homme du match', aliases: ['Joueur du match', 'Homme du match', 'HdM', 'Man of the Match', 'MOM'] },
  ...
  { key: 'selection_nationale', label: 'Sélection nationale', aliases: ['Sélection nationale', 'Selection nationale', 'Équipe nationale', 'Equipe nationale', 'National Team'] },
  { key: 'matchs_selection', label: 'Matchs en sélection', aliases: ['Matchs en sélection (saison)', 'Matchs en sélection', 'Matchs selection', 'Sél. MJ', 'Int Apps', 'International Apps'] },
  { key: 'buts_selection', label: 'Buts en sélection', aliases: ['Buts (sél.)', 'Buts en sélection', 'Buts selection', 'Sél. Buts', 'Int Gls', 'International Goals'] },
  { key: 'passes_selection', label: 'Passes décisives en sélection', aliases: ['Passes déc. en sélection', 'Passes décisives en sélection', 'Passes decisives selection', 'Sél. Pd'] },
  { key: 'note_selection', label: 'Note moyenne en sélection', aliases: ['Note moyenne en sélection', 'Moy sélection', 'Avg Rat Int', 'International Average Rating'] },
  { key: 'buts_encaisses_selection', label: 'Buts encaissés en sélection', aliases: ['Buts encaissés en sélection', 'Buts encaisses en selection', 'Sél. Buts encaissés'] },
